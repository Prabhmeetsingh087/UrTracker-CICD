    ...
    <>
            ...
            <SheetContent>
                ...
                <div className='flex flex-col justify-between h-[85vh]'>
                  <div className='flex flex-col mx-4 text-center'>
                    <Link to='/home' className='text-slate-500 text-lg border-b-2 border-y-gray-100 p-4 hover:text-slate-900 hover:border-y-gray-200'> Homesss </Link>
                    <Link to='/expense' className='text-slate-500 text-lg border-b-2 border-y-gray-100 p-4 hover:text-slate-900 hover:border-y-gray-200'> Expenses </Link>
      ...
      <div className='hidden md:visible md:flex md:flex-col h-screen bg-slate-800 md:w-1/4 lg:w-1/6'>
        ...
        <div className='flex items-center mx-auto my-8 gap-2 lg:gap-4'>
          ...
          <h1 className='font-mono text-xl md:text-xl text-white xl:text-2xl'> UrTrackersssss </h1>
        </div>

        <div className='flex flex-col justify-between h-full m-4 -mt-4'>
          <div className='flex flex-col'>
            <Link to='/home' className='text-gray-300 text-lg border-b-2 border-y-slate-700 p-4 hover:text-white hover:border-y-slate-600 md:text-xl'> Homessss </Link>
            ...
            <Link to='/dashboard' className='text-gray-300 text-lg border-y-slate-700 p-4 hover:text-white md:text-xl'> Dashboardsss </Link>
          </div>
